<template>
  <div class="flex justify-between mx-auto">
    <div class="flex flex-col" ref="scrollRef">
      ...
      <ResourceList :datas="resource_list" :fetchFn="fetchResources"></ResourceList>
    </div>
        ...
        <ul v-for="(resource, index) in hot_resources">
          <li @click="download(resource._id)">
            <a :href="resource.url" download target="_blank" class="flex relative my-2">
              ...
              <span class="inline-block w-7 h-7 bg-stone-200 rounded text-center leading-7 absolute right-0">{{
...
useScroll(scrollRef, fetchResources)
</script>
